...
#SBATCH --output=/home/rkathuria/manifolds/logs/ea-phase2-v10-%j.out
#SBATCH --error=/home/rkathuria/manifolds/logs/ea-phase2-v10-%j.err
...
PYTHONPATH=$PROJ/analysis:/home/rkathuria/activation-harvester/src \
    $PY scripts/ea_phase2_v10_sglang.py \
    ...
    --n-bins 21 --save-dim 5 \
    --out-dir figures/ea_phase2_v10
