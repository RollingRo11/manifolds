...
#SBATCH --output=/home/rkathuria/manifolds/logs/ea-v13-long-%j.out
#SBATCH --error=/home/rkathuria/manifolds/logs/ea-v13-long-%j.err
...
PYTHONPATH=$PROJ/analysis:/home/rkathuria/activation-harvester/src \
    $PY scripts/ea_phase2_v13_long_sglang.py \
    ...
    --out-dir figures/ea_phase2_v13_long
