...
#SBATCH --output=/home/rkathuria/manifolds/logs/ea-phase2-v7-%j.out
#SBATCH --error=/home/rkathuria/manifolds/logs/ea-phase2-v7-%j.err
...
PYTHONPATH=$PROJ/analysis:/home/rkathuria/activation-harvester/src \
    $PY scripts/ea_phase2_v7_sglang.py \
